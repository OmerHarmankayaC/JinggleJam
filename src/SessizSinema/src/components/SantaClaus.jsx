...
const SantaClaus = ({ onClick, state }) => {
    ...
    return (
        ...
        >
            <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-lg">
                ...
                {/* Arms */}
                {/* Left Arm (User's Left) */}
                <path d="M60 145 C40 150 30 140 35 120" stroke="#D32F2F" strokeWidth="20" strokeLinecap="round" />
                <circle cx="35" cy="120" r="10" fill="#FFFFFF" /> {/* Glove */}

                {/* Right Arm (User's Right - The one that waves) */}
                <g className={isSuccess ? 'animate-santa-hand-wave' : ''}>
                    ...
                    <circle cx="165" cy="120" r="10" fill="#FFFFFF" /> {/* Glove */}
                </g>
                ...
                <g className={isError ? 'animate-santa-head-shake' : ''}>
                    ...
                    {/* Mouth */}
                    <ellipse
                        cx="100" cy="90" rx="5" ry="3"
                        fill="#8C3E3E"
                        className={isSuccess ? 'animate-santa-mouth-hoho' : ''}
                    />
